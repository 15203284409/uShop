  ...
  <div>
    ...
    >
      ...
      <el-table-column label="是否新品">
        <template slot-scope="scope">
          <el-button type="primary" v-if="scope.row.isnew == 1" :label="1"
            >是</el-button
          >
          <el-button type="info" v-else :label="2">否</el-button>
        </template>
      </el-table-column>

      <el-table-column label="是否热卖">
        <template slot-scope="scope">
          <el-button type="primary" v-if="scope.row.ishot === 1" :label="1"
            >是</el-button
          >
          <el-button type="info" v-else :label="2">否</el-button>
        </template>
...
import { goodsDel } from "../../../utils/ajax-all";
export default {
  data() {
    return {};
  },
